  ...
  return (
	...
	<div className='bg-gray-100'>
      ...
      <div className='mx-auto max-w-screen-lg py-20 pt-16 px-4 sm:px-8 md:px-12'>
        <div className="mb-12 text-center">
          <a href="https://docs.google.com/document/d/1uPAIsGA1WWCseDOu3vO85GK0BgWiwOC-RMDS1z7i2Q8/edit?usp=sharing" target="_blank" className="bg-green-500 hover:bg-green-400 focus:outline-none focus:bg-green-400 px-6 py-4 border border-transparent text-lg font-medium rounded-md text-white transition duration-150 ease-in-out">Participant Guide</a>
        </div>
        <div className='mb-8'>
	...
	{/* <p className="text-green-800 text-3xl py-8 mb-1 font-bold"> More Information about BioCode 2024 coming soon! </p> */}
        ...
        <div className='mb-8'>
          ...
          <p className="text-gray-500 text-lg mb-3">
          For each competition category (competitive programming or hackathon), there will be three divisions: beginner (ex; middle schoolers), intermediate (ex: have not taken AP Computer Science, in high school), and advanced (have taken AP Computer Science). If you currently do not have a team, we will pair you with other students in your division if you’d like. More information will be released soon, and given during opening ceremonies.
          </p>
          <p className="text-gray-500 text-lg mb-3">
